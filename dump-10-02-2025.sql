...
(2,'TEST',4),
(10,'Moderate Risk',5),
(11,'High Risk - Please consult a healthcare professional',4),
(12,'High Risk - Please consult a healthcare professional',4);
...
--
-- Table structure for table `HealthGuide`
--
...
CREATE TABLE `HealthGuide` (
  `HealthGuideID` int(11) NOT NULL AUTO_INCREMENT,
  `HealthGuideDescription` text NOT NULL,
  `HealthGuideVideoLink` varchar(255) NOT NULL,
  `Overall_Wellbeing` varchar(255) NOT NULL,
  PRIMARY KEY (`HealthGuideID`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `HealthGuide`
--

LOCK TABLES `HealthGuide` WRITE;
/*!40000 ALTER TABLE `HealthGuide` DISABLE KEYS */;
INSERT INTO `HealthGuide` VALUES
(1,'Exercise at home','https://www.youtube.com/watch?v=j0V8SeT8840','Low Risk '),
(2,'Prevent falling in toilet','https://www.youtube.com/watch?v=PlpSQwjB5qc','Moderate Risk'),
(3,'Prevent falling','https://www.youtube.com/watch?v=FXEWg8NtGXU','High Risk - Please consult a healthcare professional'),
(4,'Upper Body Exercises','https://www.youtube.com/watch?v=Ir5hQvakCww','Low Risk '),
(5,'Upper Body Exercises','https://www.youtube.com/watch?v=Ir5hQvakCww','Moderate Risk'),
(6,'Lower Limbs Exercises','https://www.youtube.com/watch?v=JCQ3IfaIVPo','Low Risk '),
(7,'Lower Limbs Exercises','https://www.youtube.com/watch?v=JCQ3IfaIVPo','Moderate Risk'),
(8,'Knee Exercises','https://www.youtube.com/watch?v=sN6wwkT7qxs','Low Risk '),
(9,'Knee Exercises','https://www.youtube.com/watch?v=sN6wwkT7qxs','Moderate Risk');
/*!40000 ALTER TABLE `HealthGuide` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-02-10  3:54:49
