...
# Start the Llama.cpp server to expose the Med42 Llama3 Q5 model as an API with context length of 2048 tokens and port 8000
# llama-server -m models/Llama3-Med42-8B-Q5_K_M.gguf -c 2048 --host 0.0.0.0 --port 8000 -ngl 33
# Start the Llama.cpp server to expose the Med42 Llama3 Q6 model as an API with context length of 2048 tokens and port 8000
llama-server -m models/Llama3-Med42-8B-Q6_K_M.gguf -c 2048 --host 0.0.0.0 --port 8000 -ngl 33
# Testing with curl
